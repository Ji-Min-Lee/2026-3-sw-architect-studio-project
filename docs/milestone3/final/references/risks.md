...
| TR-04 | `replot()` in exec path consumes 79% of exec budget (16ms / 21ms); scales with N tabs | H | H | [EXP-03](experiments/exp-03-latency-e2e.md) / [EXP-05](experiments/exp-03-latency-e2e.md) | **R1 Lazy Rendering** — replot_count ↓75–85% (macOS); 11-tab load pending EXP-05 | ✅ Resolved |
