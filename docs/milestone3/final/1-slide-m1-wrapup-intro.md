...
|---------|-----|--------------------|
| **1st** | [QAS-1 Real-Time Performance](references/qa/qas-1-real-time-performance.md) ← structural prerequisite | C&C: DSP Pipeline |
| **2nd** | [QAS-2 Low Latency](references/qa/qas-2-low-latency-and-low-number-of-missed-beats.md) | C&C: DSP Pipeline |
| **3rd** | [QAS-3 Extensibility / Modifiability](references/qa/qas-3-extensibility-modifiability.md) | Layered, IAudioSource |
| **4th** | [QAS-4 Correctness](references/qa/qas-4-correctness.md) | C&C: FilterChain → BeatDetector |
| **5th** | [QAS-5 Measurement Accuracy](references/qa/qas-5-measurement-accuracy-error-detection-handling.md) ← usability | Goal of all views |
