...
| **Response Measure** | - WeiShi No.1000 대비 Rate 오차: **< 5 s/d** *(잠정, [EX-02](./planned-experiments.md#ex-02-tg_c_placement_t-비교--placement-setting-comparison)·[EX-03](./planned-experiments.md#ex-03-weishi--rpi-동시-측정-환경--simultaneous-weishi--rpi-measurement-setup) 결과 후 확정)*<br>- WeiShi No.1000 대비 Beat Error 오차: **< 0.1 ms** *(잠정, [EX-02](./planned-experiments.md#ex-02-tg_c_placement_t-비교--placement-setting-comparison)·[EX-03](./planned-experiments.md#ex-03-weishi--rpi-동시-측정-환경--simultaneous-weishi--rpi-measurement-setup) 결과 후 확정)*<br>- 신호 열화 시 graceful degradation (불안정 출력 없음) |
...
| **Response Measure** | - ① capture→process: **< 70 ms** *(잠정)*<br>- ② process→display: **< 30 ms** *(잠정)*<br>- ③ end-to-end: **< 100 ms** *(잠정, 28,800 BPH 기준)*<br>- Dropped audio block: 0, Missed beat: 0<br>*([EX-01](./planned-experiments.md#ex-01-rpi-성능-벤치마크--rpi-performance-benchmark)·[EX-02](./planned-experiments.md#ex-02-tg_c_placement_t-비교--placement-setting-comparison) 결과 후 확정)* |
