...
gantt
    ...
    section P1 (06/10~12)
    팀1: QAS-1 실시간 (AP-1+AP-2+EXP-01)  :s1t1, 2026-06-10, 2d
    팀2: QAS-5 기반 (AP-3 설계)            :s1t2, 2026-06-10, 2d
    버퍼 W1 — EXP-01 분석                  :buf1, 2026-06-12, 1d

    section P2 (06/15~16)
    팀1: QAS-1 완성 (AP-6 폴백)            :s2t1, 2026-06-15, 2d
    팀2: QAS-3 시작 (AP-3+AP-4+EXP-03)    :s2t2, 2026-06-15, 2d

    section P3 (06/17~19)
    팀1: QAS-2 저지연 (EXP-02+AP-7a)      :s3t1, 2026-06-17, 2d
    팀2: QAS-3 완성 (EXP-03+AP-5)         :s3t2, 2026-06-17, 2d
    버퍼 W2 — M2 준비                      :buf2, 2026-06-19, 1d

    section P4 (06/22~23)
    팀1: QAS-4 사용성 + 핵심 그래프        :s4t1, 2026-06-22, 2d
    팀2: QAS-5 전체 그래프 구현            :s4t2, 2026-06-22, 2d

    section P5 (06/24~26)
    팀1+팀2: RPi 통합 빌드 + 안정화        :s5, 2026-06-24, 2d
    RPi 통합 검증일 ★ 기술 마감           :crit, rpiv, 2026-06-26, 1d
