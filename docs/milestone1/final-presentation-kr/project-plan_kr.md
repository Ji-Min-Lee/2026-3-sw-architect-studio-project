...
| 순위 | 목표 | 설명 |
|:---:|-----|-----|
| **1위** | 정확한 측정 | 레이트 / 진폭 / 박자 오차를 정확하게 제공 — 더 많은 BPH를 지원하기 위해 정확도를 희생하는 것은 허용 불가 |
| **2위** | 더 넓은 BPH 지원 | 정확도를 유지하면서 더 빠른 BPH 시계까지 정확한 지원 범위 확장 |
...
| **확장** | 추가 QAS-5 시각화 및 BPH 확장 시나리오; 시간이 허용되면 추가 | 2위: 더 넓은 BPH 지원 |
