...
> QA별 전술·어프로치·실험의 상세 매핑은 **[05-architectural-approaches.md §4 드라이버↔어프로치 추적성](05-architectural-approaches.md#4-드라이버--어프로치-추적성--driverapproach-traceability)** 참조.
>
> Detailed QA–tactic–experiment mapping: see **[05-architectural-approaches.md §4 Driver–Approach Traceability](05-architectural-approaches.md#4-드라이버--어프로치-추적성--driverapproach-traceability)**.
...
> 미결 이슈 전체 목록(프로젝트 영향·연결 리스크·액션 포함)은 **[03-risk-assessment.md §4 미결 이슈](03-risk-assessment.md#4-미결-이슈--프로젝트-결과-연결--open-issues--project-outcome-linkage)** 참조.
>
> Full open issues list (project impact, linked risks, actions): see **[03-risk-assessment.md §4 Open Issues](03-risk-assessment.md#4-미결-이슈--프로젝트-결과-연결--open-issues--project-outcome-linkage)**.
