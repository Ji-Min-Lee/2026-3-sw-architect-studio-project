...
| **Stretch** | QAS-5 시각화 추가·BPH 확장 시나리오. 시간 여유 시 추가 | (구 2위 목표 — 현재 범위 외) |
...
| **Stretch** | Additional QAS-5 visualizations and BPH-extension scenarios; added if time permits | (former 2nd goal — outside current scope) |
