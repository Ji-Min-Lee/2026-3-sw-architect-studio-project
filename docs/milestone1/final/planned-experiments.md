...
| **EXP-02** | end-to-end 지연 3구간 타임스탬프 측정 | QAS-2 | TR-03, TR-04 | OI-L1, OI-L2, OI-L3 | Sprint 2~3 (Week 1~2) |
...
> **참고**: 수행 시점은 프로젝트 플랜 초안 기준이며 확정 일정이 아니다. 선행 조건이 있는 실험(EXP-02, EXP-03, EXP-04)은 EXP-01 결과 및 Observer 패턴 리팩터링 완료 후 진행한다.
...
| **EXP-02** | End-to-End Latency — 3-Segment Timestamp Measurement | QAS-2 | TR-03, TR-04 | OI-L1, OI-L2, OI-L3 | Sprint 2–3 (Week 1–2) |
...
> **Note**: Timing references the draft project plan and is not final. Experiments with prerequisites (EXP-02, EXP-03, EXP-04) proceed after EXP-01 results are confirmed and Observer pattern refactoring is complete.
...
- "After achieving 28,800 BPH, can the target be raised to 36,000 / 43,200 BPH? (OI-L3)"
...
- Basis for team consensus on BPH target escalation (OI-L3)
