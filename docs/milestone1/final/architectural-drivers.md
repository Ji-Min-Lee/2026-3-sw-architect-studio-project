...
> QA별 전술·어프로치·실험의 상세 매핑은 **[architectural-approaches.md §4 드라이버↔어프로치 추적성](architectural-approaches.md#4-드라이버--어프로치-추적성--driverapproach-traceability)** 참조.
>
> Detailed QA–tactic–experiment mapping: see **[architectural-approaches.md §4 Driver–Approach Traceability](architectural-approaches.md#4-드라이버--어프로치-추적성--driverapproach-traceability)**.
...
> 미결 이슈 전체 목록(프로젝트 영향·연결 리스크·액션 포함)은 **[risk-assessment.md §4 미결 이슈](risk-assessment.md#4-미결-이슈--프로젝트-결과-연결--open-issues--project-outcome-linkage)** 참조.
>
> Full open issues list (project impact, linked risks, actions): see **[risk-assessment.md §4 Open Issues](risk-assessment.md#4-미결-이슈--프로젝트-결과-연결--open-issues--project-outcome-linkage)**.
