...
> **권장 실행 순서 / Recommended Order**: EX-01 & EX-02 (병렬 / parallel) → EX-03
...
## EX-02: WeiShi & RPi 동시 측정 환경 / Simultaneous WeiShi & RPi Measurement Setup
...
QAS-2는 WeiShi No.1000 대비 오차를 기준으로 한다. 동일 입력 신호 없이는 시계 운동 변동성 때문에 두 장비의 측정값을 의미 있게 비교할 수 없다 (OI-09, TR-08). 이 실험 결과가 EX-03의 측정 방식을 확정한다.
...
**한국어** 목표 완료: **2026-06-07** *(EX-03 이전)*

**English** Target completion: **2026-06-07** *(before EX-03)*
...
## EX-03: `tg_c_placement_t` 비교 / Placement Setting Comparison
...
**한국어** 목표 완료: **2026-06-08** *(EX-02 완료 후)*

**English** Target completion: **2026-06-08** *(after EX-02 concluded)*
