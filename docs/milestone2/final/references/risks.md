...
|----|-------------|:----:|:------:|------------|------------|:------:|
| TR-01 | RPi 5 cannot sustain 96kHz audio capture without block drops while Qt GUI runs | M | H | [EXP-01](experiments/exp-02-realtime-dropped-block.md) | 96kHz confirmed: Dropped=0 at all sps; SCHED_RR not required; ADR-003 Accepted | ✅ Resolved |
| TR-02 | Single-threaded pipeline saturates cpu2 (91%); 43% deadline miss on RPi | H | H | [EXP-02](experiments/exp-03-latency-e2e.md) | **T2 DSP Offload Thread** — wait_ms ×32,000 reduction, backlog 0% (macOS + RPi E2-5) | ✅ Resolved |
