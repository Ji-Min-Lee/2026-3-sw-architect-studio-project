...
| ★ | [TR-10](references/risks.md) 🔴 | UI event loop picks up beat signals too late to meet the real-time deadline | [EXP-03](references/experiments/exp-03-latency-e2e.md) E2-7 | 🔴 Unresolved | E2-8: SCHED_RR / QTimer polling — scheduled 06/22 |
